...
const AddProductsByVendor = () => {
  ...
  async function addItemm() {
    ...
    if (error) {
      ...
      navigation.navigate(Routes.AccountVendorProducts);
    }
  }
...
export default AddProductsByVendor;
